...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description:
        'Shown as a label on the card. Water = sea temps & conditions. News = hours, pricing, events. Stories = people & experiences.',
    ...
    defineField({
      ...
      type: 'image',
      description:
        'Upload a photo from your camera roll or files. JPG or WebP, minimum 1000px wide. Enable the hotspot to choose which part stays in frame when cropped.',
      options: {
        hotspot: true,
      },
      fields: [
        defineField({
          ...
          type: 'string',
          description:
            'Describe the image for screen readers, e.g. "Waves breaking at Wicklow pier at sunrise".',
        }),
      ],
    }),
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'Chimney smoke at dusk', value: 'chimney-smoke' },
          { title: 'Tide clock on cedar wall', value: 'tide-clock' },
          { title: 'Life ring through the reeds', value: 'life-ring' },
          { title: 'Fuchsia and bamboo', value: 'fuchsia' },
          { title: 'Flower planter by the sauna', value: 'flower-planter' },
          { title: 'Cold-plunge splash', value: 'plunge-splash' },
          { title: 'Friends sea-swimming', value: 'sea-swim-friends' },
        ],
      },
    }),
    defineField({
